...
description: Production-ready REST API server for Kubiya SDK
icon: server
---

# SDK Server Overview

The Kubiya SDK includes a production-ready REST API server that provides HTTP endpoints for workflow management, AI-powered generation, and real-time execution streaming.
...
# Using Python module
python -m kubiya.server

# Using Docker
docker run -p 8000:8000 kubiya-server
```
