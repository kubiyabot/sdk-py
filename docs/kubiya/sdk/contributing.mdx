...
description: "Guide for contributing to the Kubiya SDK"
icon: "code-branch"
tags: ["sdk"]
---
...
Thank you for your interest in contributing to the Kubiya SDK! This guide will help you get started.
...
git clone https://github.com/YOUR-USERNAME/kubiya-sdk.git
cd kubiya-sdk

# Add upstream remote
git remote add upstream https://github.com/kubiya-sandbox/kubiya-sdk.git
```
...
import pytest
from kubiya_sdk import YourNewFeature
...
# Run with coverage
pytest --cov=kubiya_sdk --cov-report=html

# Run linting
flake8 kubiya_sdk/
black --check kubiya_sdk/
mypy kubiya_sdk/
```
...
```python
# kubiya_sdk/providers/custom.py
...
```python
# kubiya_sdk/core/steps/custom_step.py
...
- **GitHub Issues**: [Report bugs](https://github.com/kubiya-sandbox/kubiya-sdk/issues)
- **Discussions**: [Ask questions](https://github.com/kubiya-sandbox/kubiya-sdk/discussions)
