...
```python
from kubiya_sdk.dsl import workflow, shell_executor, python_executor
...
```python
from kubiya_sdk.dsl import workflow, inline_agent_executor
...
```python
from kubiya_sdk.dsl import workflow, python_executor
...
- **[Workflow DSL Reference](../workflows/dsl-reference)** - Complete DSL API reference
- **[Advanced Workflows](../workflows/advanced)** - Advanced workflow patterns
- **[API Reference](./api-reference)** - Complete SDK API docs
- **[Client SDK](./client/overview)** - Learn the Kubiya Python client