...
1. Check [existing issues](https://github.com/kubiya-sandbox/kubiya/issues)
2. Create a [new issue](https://github.com/kubiya-sandbox/kubiya/issues/new)
3. Include:
   - SDK version
   - Python version
...
<Note>
  Stay updated with the latest changes by watching our [GitHub repository](https://github.com/kubiya-sandbox/kubiya).
</Note> 