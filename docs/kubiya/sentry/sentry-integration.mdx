# Sentry Integration for Kubiya SDK

The Kubiya SDK now includes optional Sentry integration for error tracking and performance monitoring. This integration is completely optional and can be enabled through environment variables or CLI flags.
...
3. **Import Errors**
   - Install sentry dependencies: `pip install kubiya-sdk[sentry]` or `pip install kubiya-sdk[all]`
...
```python
from kubiya_sdk import is_sentry_initialized, is_sentry_enabled
...
3. Open an issue in the Kubiya SDK repository
