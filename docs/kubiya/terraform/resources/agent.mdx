...
```hcl Agent with STDIO MCP
resource "kubiya_agent" "example" {
  name         = "MCP-Enabled Agent"
  runner       = "default"
  description  = "Agent with MCP integration"
  instructions = "AI assistant with MCP tools"
  
  mcp_server {
    type    = "stdio"              # Required
    command = "python"             # Required
    args    = ["-m", "mcp.server"] # Optional
    env = {                        # Optional
      DEBUG = "true"
    }
  }
...
resource "kubiya_agent" "example" {
  ...
  mcp_server {
    type = "sse"                          # Required
    url  = "https://mcp.deepwiki.com/sse" # Required
    headers = {                           # Optional
