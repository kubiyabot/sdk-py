...
<CardGroup>
  <Card title="MCP Documentation" icon="book" href="/mcpserver/overview">
    Learn about the Model Context Protocol
  </Card>
  
  <Card title="Agent Server Guide" icon="server" href="/mcpserver/agent-server">
  ...
  <Card title="Examples" icon="flask" href="/mcpserver/examples">
