...
# devops_agent.py
import os
from kubiya_sdk.mcp import AgentServer
...
```python
# data_agent.py
from kubiya_sdk.cli import main
import sys
...
from kubiya_sdk.cli import run_agent_server
...
- Explore the [MCP Agent Server documentation](/mcpserver/agent-server) for advanced features
- Learn about [custom tool development](/mcpserver/tools-reference)
