...
**Parameters:**
- `tool_name_or_instance`: Either a string name of a pre-registered tool, or a Tool class instance from `kubiya.tools.models`
...
```python
from kubiya.dsl import shell_executor
...
```python
from kubiya.dsl import python_executor
...
```python
from kubiya.dsl import docker_executor
...
```python
from kubiya.dsl import inline_agent_executor
...
```python
from kubiya.dsl import workflow, python_executor, shell_executor
