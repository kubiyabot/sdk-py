...
**Parameters:**
- `tool_name_or_instance`: Either a string name of a pre-registered tool, or a Tool class instance from `kubiya_sdk.tools.models`
...
```python
from kubiya_sdk.dsl import shell_executor
...
```python
from kubiya_sdk.dsl import python_executor
...
```python
from kubiya_sdk.dsl import docker_executor
...
```python
from kubiya_sdk.dsl import inline_agent_executor
...
```python
from kubiya_sdk.dsl import workflow, python_executor, shell_executor
