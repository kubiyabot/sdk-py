...
try:
    from kubiya_sdk.providers.adk import ADKConfig
...
def test_basic_import():
    ...
    try:
        from kubiya_sdk import KubiyaClient
        from kubiya_sdk.providers import get_provider
        from kubiya_sdk.providers.adk import ADKConfig, ModelProvider
...
def main():
    ...
    if passed == len(tests):
        ...
        print("2. Run the examples: python kubiya_sdk/providers/adk/example.py")
        return 0
    else:
...
echo "   python kubiya_sdk/providers/adk/example.py"
echo ""
echo "4. Or start coding:"
echo "   python"
echo "   >>> from kubiya_sdk.providers import get_provider"
echo "   >>> # ... see README for usage"
echo ""
echo "Documentation: kubiya_sdk/providers/adk/README.md"
echo "==========================================" 