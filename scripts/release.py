...
def get_current_version():
    ...
    version_file = Path("kubiya/__version__.py")
...
def main():
    parser = argparse.ArgumentParser(description="Release kubiya")
    parser.add_argument(
        "version_type",
    ...
    # Commit changes
    run_command(f'git add kubiya/__version__.py')
